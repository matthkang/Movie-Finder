...
var populateResults = function () {
    ...
    for (var i = 0; i < moviesArr.length; i++) {
        ...
        var trailer = fetchYoutubeData(title)
                var movie = $(`
            ...
            <a href class="w-24 p-2 mt-4 bg-gray-200 rounded-lg dark:bg-gray-700 target=_blank"> ${"https://www.youtube.com/watch?v=" + trailer}</a>
